...
const ChangeDataForm = ({ profileUserData, updateStatus, userStatus, updateAvatar, setEditMode, handleSubmit }) => {
	...
	return (
		<>
			...
			<div className={status}>status: <UserStatusWithHook userStatus={userStatus} updateStatus={updateStatus} /></div>
