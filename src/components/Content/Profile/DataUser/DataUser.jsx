...
const DataUser = ({profileUserData, putMyStatusOnServerThunk, userStatus, userIdInUrl, changeAvatarThunk}) => {

	const uploadFile = (e) => {
		changeAvatarThunk(e.target.files[0]);
	}

	const btnChangeAvatar = !userIdInUrl 
											? <input 
												onChange={uploadFile} 
												type='file' 
	...
	return (
		<div className={my_data}>
				<div className={avatar}><img src={photo}/>{btnChangeAvatar}</div>
